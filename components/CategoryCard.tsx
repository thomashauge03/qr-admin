      ...
      <div style={{ padding: '16px 16px 12px' }}>
        <div className="flex items-start gap-3">
          ...
          <div className="shrink-0 rounded-xl p-2"
            ...
            <QRCodeSVG value={qrValue} size={64} bgColor="transparent" fgColor="#000" level="M" />
          </div>

          {/* Info */}
          <div className="flex-1 min-w-0">
            <h3 className="font-display"
              style={{ fontSize: '1.05rem', fontWeight: 700, letterSpacing: '-0.02em', lineHeight: 1.3, color: 'var(--ink)', wordBreak: 'break-word' }}>
              {category.name}
            </h3>
            ...
            {category.description && (
              <p className="mt-1.5 line-clamp-2"
                style={{ fontSize: '0.85rem', color: 'var(--muted)', lineHeight: 1.5 }}>
                {category.description}
              </p>
            )}
          </div>
      ...
      <div className="flex" style={{ borderTop: '1px solid var(--border)' }}>
        {[
          { label: 'Print',   fn: () => onPrint(category), danger: false,
            icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg> },
